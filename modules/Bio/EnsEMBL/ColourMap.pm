...
sub new {
  ...
  $self->colourSet( 'ensembl_gene',
    ...
    'havana_protein_coding_KNOWN'  => [ 'dodgerblue4', 'Havana Protein coding'],
    'havana_protein_coding_NOVEL'  => [ 'dodgerblue4',        'Havana Protein coding' ],
    'havana_havana_pseudogene_KNOWN' => [ 'deeppink3', 'Havana Pseudogene' ],
    'havana_IG_pseudogene_KNOWN' => [ 'deeppink3', 'Havana Pseudogene' ],
    'havana_processed_pseudogene_KNOWN' => [ 'deeppink3', 'Havana Pseudogene' ],
    'havana_unprocessed_pseudogene_KNOWN' => [ 'deeppink3', 'Havana Pseudogene' ],
    'havana_processed_pseudogene_NOVEL' => [ 'deeppink3', 'Havana Pseudogene' ],
    'havana_unprocessed_pseudogene_NOVEL' => [ 'deeppink3', 'Havana Pseudogene' ],
