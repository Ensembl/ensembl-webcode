...
sub handler {
  ...
  my $message = 'Please check that you have typed in the correct URL or else use the <a href="/Multi/Search/Results">site search</a> facility to try and locate information you require.<br />If you think an error has occurred, please <a href="mailto:' . $SiteDefs::ENSEMBL_HELPDESK_EMAIL . '">contact our HelpDesk</a>';
