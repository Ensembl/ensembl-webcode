...
sub stats {
  ...
  $html .= qq(  </table>
  <p>For more information on these statistics, see the <a href="javascript:void(window.open('/$species/helpview?kw=mapview;se=1','helpview','width=700,height=550,resizable,scrollbars'))">MapView help</a> page</p>  );
