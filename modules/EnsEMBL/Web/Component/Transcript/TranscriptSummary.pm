...
sub content {
  ...
  $table->add_row('GENCODE primary gene', qq(This transcript is a member of the <a href="https://www.gencodegenes.org/pages/gencode_primary/" class="popup">Gencode Primary</a> gene set.)) if(@{$transcript->get_all_Attributes('gencode_primary')});
