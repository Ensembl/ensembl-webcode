...
sub content {
  ...
  $upload_fieldset->add_button({ 'field_class' => 'hidden _stt_upload1', 'name' => 'submit', 'value' => 'Upload' })->inputs->[0]->after($self->dom->create_element('label', {
    'inner_HTML'  => 'Please provide one of the above three fields',
    'class'       => '_userdata_upload_error hidden'
  }));
  $upload_fieldset->add_button({ 'field_class' => 'hidden _stt_remote1', 'name' => 'submit', 'value' => 'Attach' });
