...
sub menus {
  my $self = shift;
  my $dna_align_title =  'Other alignments';
  my $dna_align_menu  =  'mrna_prot';
  if ($self->species =~ /Mus_|Homo/) {
    $dna_align_title = 'GRC Alignments';
    $dna_align_menu  = 'seq_assembly';
  }
  return $self->{'menus'} ||= {
    # Sequence
    ...
    dna_align_other     => [ $dna_align_title,          $dna_align_menu ],
