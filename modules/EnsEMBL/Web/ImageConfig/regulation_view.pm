...
sub init_cacheable {
  ...
  # foreach my $type (qw(reg_feats reg_feats_non_core reg_feats_core)) {
  ...
  #   $self->{'reg_feats_tracks'}{$_} = 1 for "reg_feats_$cell_line", "reg_feats_core_$cell_line", "reg_feats_non_core_$cell_line";
  # }
