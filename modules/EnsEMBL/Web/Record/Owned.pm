package EnsEMBL::Web::Record::Owned;

### Parent class for records that belong to a user or group
## Can be multiply-inherited with Record::Trackable
...
sub attach_owner {
  ...
  if ($record_type eq 'group') {
    $self->add_belongs_to("EnsEMBL::Web::Record::Account::Group");
  }
  else {
    $self->add_belongs_to("EnsEMBL::Web::Record::Account::User");
  }
}
